...
class SubClass extends SuperClass{
	...
	protected String methodThree(int k, String s){
		intNumber=k;
 		memberString=s;
	...
	String methodThree(String str,int k){   //오버로딩이니깐 인수 순서라도 바꾸기, 오버로딩이라 하나만 오버라이딩해도 됨, 오버라이딩한 거는 부모 꺼랑 인수 순서 같게!!
		intNumber=k;
 		memberString=str;
 		System.out.println("SubClass객체의 methodThree()메소드가 호출되었습니다.");
 		System.out.println("intNumber="+intNumber+"\t"+"memberString="+memberString);
